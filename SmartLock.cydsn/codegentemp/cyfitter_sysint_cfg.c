...
/* ARM CM0+ */
    ...
    /* SCB_SCB_IRQ */
    const cy_stc_sysint_t SCB_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)SCB_SCB_IRQ__INTC_CORTEXM0P_MUX,
        .cm0pSrc = (cy_en_intr_t)SCB_SCB_IRQ__INTC_NUMBER,
        .intrPriority = SCB_SCB_IRQ__INTC_CORTEXM0P_PRIORITY
    };
